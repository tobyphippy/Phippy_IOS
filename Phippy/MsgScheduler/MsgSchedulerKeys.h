...
static NSString * MSKEY_FOODSTORE_Delivertime     =@"deliver_time";
static NSString * MSKEY_FOODSTORE_Phone_number    =@"phone_number";
static NSString * MSKEY_FOODSTORE_Qisongcondition =@"qisong_condition";
